    ...
    <template #content style="width: 25rem; margin-bottom: 2em">
      <div v-if="prediction.scenario_id == 1">
        ...
        <p>
          ...
          ущерб, причиненный преступлением. Почитайте **инструкцию «Как
          прекратить уголовное дело за хранение наркотиков и получить судебный
          штраф?».**
        </p>
      </div>
      <div v-if="prediction.scenario_id == 2">
        ...
        <p>
          ...
          обстоятельствах и других аспектах уголовного дела смотрите в
          Путеводителе по законодательству и судебной практике для обвиняемых и
          осужденных за наркотики.
        </p>
      </div>
